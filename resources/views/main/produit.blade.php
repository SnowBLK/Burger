...
<!-- Mirrored from designarc.biz/demos/wengdo/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Jul 2022 19:08:15 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="info-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        ...
                                        <div class="other-options clearfix">
                                            <div class="item-quantity"><label class="field-label">Quantité
                                                    :</label><input
                                                    id="quantiteInput"
                                                    class="quantity-spinner" type="text" value="1"
                                                    name="quantity"></div>
                                            <button id="ajoutPanier" onclick="ajoutPanierFunction()"
                                                    type="button" class="theme-btn btn-style-five"><span class="txt">Ajouter
...
<!-- Mirrored from designarc.biz/demos/wengdo/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Jul 2022 19:08:25 GMT -->
</html>
